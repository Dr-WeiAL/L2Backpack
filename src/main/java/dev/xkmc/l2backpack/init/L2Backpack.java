...
public class L2Backpack {
	...
	public L2Backpack() {
		...
		//TODO if (ModList.get().isLoaded("modulargolems")) GolemCompat.register();
		...
		//TODO if (ModList.get().isLoaded("patchouli")) PatchouliCompat.gen();
	...
	public static void gatherData(GatherDataEvent event) {
		...
		// TODO gen.addProvider(server, new SlotGen(gen));
		//TODO ignore event.getGenerator().addProvider(event.includeServer(), new BackpackGLMProvider(event.getGenerator().getPackOutput()));
	}
