...
public class ArmorBagMenu extends BaseBagMenu<ArmorBagMenu> {
	...
	public static ArmorBagMenu fromNetwork(MenuType<ArmorBagMenu> type, int windowId, Inventory inv, RegistryFriendlyByteBuf buf) {
	...
	public ArmorBagMenu(int windowId, Inventory inventory, PlayerSlot<?> hand, UUID uuid, @Nullable Component title) {
		super(LBMenu.MT_ARMOR.get(), windowId, inventory, MANAGERS, hand, uuid, 1);
	}
